                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${users}" var="user">
                                    <tr>
                                        ...
                                        <th>${user.email}</th>
                                        <th>
                                            <a href="http://localhost:8080/user/delete?id=${user.id}">Delete</a>
                                            <a href="http://localhost:8080/user/edit?id=${user.id}">Edit</a>
                                            <a href="http://localhost:8080/user/show?id=${user.id}">Show</a>
                                        </th>
                                    </tr>
                                </c:forEach>
